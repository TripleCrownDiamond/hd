 ...
 *
 * Lucide dropped third-party marks, so the ones the shop links to are drawn
 * here. Same 24-unit box, `currentColor` fill and caller-sized className as the
 * Lucide icons they sit beside, so a mixed row stays visually even.
 */
