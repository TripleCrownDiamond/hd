...
// de démonstration. Les prix ont été ajustés (−30 %). Source originale :
...
export const stammholzProducts: StammholzProduct[] = [
  {
    ...
    packaging: "LKW lose",
    priceCents: 4095000,
    basePriceCents: 81900,
    basePriceUnit: "Rm",
    pricePerRmCents: 81900,
    variants: [
      { id: "s1-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 1023750, available: true },
      { id: "s1-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 2047500, available: true },
      { id: "s1-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 4095000, available: true },
      { id: "s1-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 8190000, available: true },
    ],
  ...
  },
  {
    ...
    packaging: "LKW lose",
    priceCents: 5040000,
    basePriceCents: 100800,
    basePriceUnit: "Rm",
    pricePerRmCents: 100800,
    variants: [
      { id: "s2-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 1260000, available: true },
      { id: "s2-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 2520000, available: true },
      { id: "s2-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 5040000, available: true },
      { id: "s2-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 10080000, available: true },
    ],
  ...
  },
  {
    ...
    packaging: "LKW lose",
    priceCents: 5390000,
    basePriceCents: 107800,
    basePriceUnit: "Rm",
    pricePerRmCents: 107800,
    variants: [
      { id: "s3-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 1347500, available: true },
      { id: "s3-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 2695000, available: true },
      { id: "s3-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 5390000, available: true },
      { id: "s3-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 10780000, available: true },
    ],
  ...
  },
  {
    ...
    packaging: "LKW lose",
    priceCents: 4830000,
    basePriceCents: 96600,
    basePriceUnit: "Rm",
    pricePerRmCents: 96600,
    variants: [
      { id: "s4-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 1207500, available: true },
      { id: "s4-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 2415000, available: true },
      { id: "s4-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 4830000, available: true },
      { id: "s4-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 9660000, available: true },
    ],
  ...
  },
  {
    ...
    basePriceUnit: "Rm",
    pricePerRmCents: 70000,
    variants: [
      { id: "s5-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 875000, available: true },
      { id: "s5-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 1750000, available: true },
      { id: "s5-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 3500000, available: true },
      { id: "s5-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 7000000, available: true },
    ],
  ...
  },
  {
    ...
    packaging: "LKW lose",
    priceCents: 4193000,
    basePriceCents: 83860,
    basePriceUnit: "Rm",
    pricePerRmCents: 83860,
    variants: [
      { id: "s6-v1", label: "Viertel-LKW", rm: 12.5, description: "12,5 Rm — ca. ¼ Ladung", priceCents: 1048250, available: true },
      { id: "s6-v2", label: "Halb-LKW", rm: 25, description: "25 Rm — ca. ½ Ladung", priceCents: 2096500, available: true },
      { id: "s6-v3", label: "Voll-LKW", rm: 50, description: "50 Rm — komplette Ladung", priceCents: 4193000, available: true },
      { id: "s6-v4", label: "Doppel-LKW", rm: 100, description: "100 Rm — 2 Ladungen", priceCents: 8386000, available: true },
    ],
